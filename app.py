...
def render_inspector_panel(signal: TradeSignal):
    ...
    with tab1:
        ...
        with col4:
            ...
            win_rate = signal.metadata.get("historic_win_rate", 0.0)
            ...
            st.markdown(f'''
                ...
                <div class="metric-row">
                    <span class="metric-label">Historic Win Rate</span>
    ...
    with tab2:
        ...
        with col6:
            backtest_trades = signal.metadata.get("backtest_trades", 0)
            ...
            st.markdown(f'''
                ...
                <div class="metric-row">
                    <span class="metric-label">Backtest Trades</span>
                    <span class="metric-value">{backtest_trades}</span>
                </div>
                <div class="metric-row">
...
def main():
    ...
    with st.sidebar:
        ...
        if st.button("🔍 Scan Nifty 500", type="primary", use_container_width=True):
            with st.spinner("Analyzing market..."):
                ...
                # Step 2: Scan all tickers with strategies
                ...
                calibrated_tickets = calibration.calibrate(all_tickets, regime=regime)
